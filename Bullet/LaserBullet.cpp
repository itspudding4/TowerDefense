...
LaserBullet::LaserBullet(Engine::Point position, Engine::Point forwardDirection, float rotation, Turret *parent) : Bullet("play/bullet-2.png", 800, 2* getPlayScene()->dmgMultiplier, position, forwardDirection, rotation - ALLEGRO_PI / 2, parent) {
}
